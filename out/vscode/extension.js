...
function activate(context) {
    ...
    const serverOptions = {
        ...
        debug: { module: serverModule, transport: node_1.TransportKind.ipc, options: { execArgv: ['--inspect=6009'] } },
    };
    const clientOptions = {
    ...
    client = new node_1.LanguageClient('viewtree-lsp', 'view.tree LSP', serverOptions, clientOptions);
